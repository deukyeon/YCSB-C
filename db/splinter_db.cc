...
int
SplinterDB::Read(const string         &table,
                 const string         &key,
                 ...
                 vector<KVPair>       &result)
{
   ...
   splinterdb_lookup_result_init(spl,
                                 &lookup_result,
...
int
SplinterDB::Scan(const string           &table,
                 const string           &key,
                 int                     len,
                 const vector<string>   *fields,
...
int
SplinterDB::Update(const string   &table,
                   const string   &key,
...
int
SplinterDB::Insert(const string   &table,
                   const string   &key,
                   vector<KVPair> &values)
{
...
int
SplinterDB::Delete(const string &table, const string &key)
{
   slice key_slice = slice_create(key.size(), key.c_str());
